			...
			<div class="about-top grid-1">
				<div class="col-md-4 about-left">
					<figure class="effect-bubba">
						<img class="img-responsive" src="images/hahaha.jpg" alt=""/>
						<figcaption>
							<h2>Chanel</h2>
							<p>on sale</p>	
						</figcaption>			
			...
			<s:if test="#session.user.name =='admin'">
		            ...
		            <div class="col-md-3 product-left">
						<div class="product-main simpleCart_shelfItem">
							<a href="tjsp.jsp"><img class="img-responsive zoom-img" src="images/1515.jpg" alt="" /></a>
				  ...
				  <s:iterator value="goodsList" status="status">
					<div class="col-md-3 product-left">
						<div class="product-main simpleCart_shelfItem">
							<a href="goods/goods_showDetail?goods.goodsid=<s:property value='goodsid'/>" class="mask"><img class="img-responsive zoom-img" src="<%=basePath%><s:property value='filepath'/>" alt="" /></a>
							<div class="product-bottom">
								<h3><s:property value="goodsname"/></h3>
								 <a href="order/order_addOrder?goods.goodsid=<s:property 
	                  value='goodsid'/>&user.name=<s:property value='#session.user.name'/>" class="add-order">
								<p>立即下单</p>
								</a>
								<h4><a class="item_add" href="#"><i></i></a> <span class=" item_price">&yen;<s:property value="price"/></span></h4>
							</div>
							<div class="srch">
								<span>-50%</span>
							</div>
