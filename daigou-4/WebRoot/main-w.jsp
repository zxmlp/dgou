			...
			<s:if test="#session.user.name =='admin'">
		            ...
		            <div class="col-md-3 product-left">
						<div class="product-main simpleCart_shelfItem">
							<a href="tjsp-w.jsp"><img class="img-responsive zoom-img" src="images/1515.jpg" alt="" /></a>
				  ...
				  <s:iterator value="watchList" status="status">
					<div class="col-md-3 product-left">
						<div class="product-main simpleCart_shelfItem">
							<a href="watch/watch_showDetail?watch.watchid=<s:property value='watchid'/>" class="mask"><img class="img-responsive zoom-img" src="<%=basePath%><s:property value='wfilepath'/>" alt="" /></a>
							<div class="product-bottom">
								<h3><s:property value="watchname"/></h3>
								 <a href="order/order_addOrder?watch.watchid=<s:property 
	                  value='watchid'/>&user.name=<s:property value='#session.user.name'/>" class="add-order">
								<p>立即下单</p>
								</a>
								<h4><a class="item_add" href="#"><i></i></a> <span class=" item_price">&yen;<s:property value="wprice"/></span></h4>
							</div>
							<div class="srch">
								<span>-50%</span>
							</div>
